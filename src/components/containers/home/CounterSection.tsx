            ...
            <div style={{ ...counterStyle, flex: '1 1 25%' }}>
              <div>
                <strong style={numberStyle}>
                  <CountUp style={{fontSize:'30px'}} end={18} duration={2} suffix="+" />
                </strong>
                <label className='ps-1' style={labelStyle}>Business Year</label>
              </div>
            </div>
            <div style={{ ...counterStyle, flex: '1 1 25%' }}>
              <div>
                <strong style={numberStyle}>
                  <CountUp style={{fontSize:'30px'}} end={240} duration={2} suffix="+" />
                </strong>
                <label className='ps-1' style={labelStyle}>Satisfied Clients</label>
              </div>
            </div>
            <div style={{ ...counterStyle, flex: '1 1 25%' }}>
              <div>
                <strong style={numberStyle}>
                  <CountUp style={{fontSize:'30px'}} end={2000} duration={2} suffix="+" />
                </strong>
                <label className='ps-1' style={labelStyle}>Successful Cases</label>
              </div>
            </div>
            <div style={{ ...counterStyle, flex: '1 1 25%' }}>
              <div>
                <strong style={numberStyle}>
                  <CountUp style={{fontSize:'30px'}} end={100} duration={2} suffix="+" />
                </strong>
                <label className='ps-1' style={labelStyle}>Our Projects</label>
              </div>
            </div>
          </>
        )}
