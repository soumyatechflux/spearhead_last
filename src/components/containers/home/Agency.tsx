            ...
            <div className="row justify-content-center">
              ...
              <div className="ceo-msg mb-4">
                <h6 className="ceo-msg ">
                  ...
                  For over 20 years, Paul Williams has been working with some of the world’s most prestigious brands, helping them achieve commercial success through strategy-driven creativity. This includes implementing household names such as Arabian Business (Arabic and English) and acting as a catalyst of change for the likes of Dubai Tourism, Marriott International, Accor, ADCB, Cartier, Expo2020, Government entities, and Family-run offices. 
                  
                </h6>
      
                  {isReadMore && (
                    <p className="ceo-msg" >
                      <br />As an award-winning sales professional and senior management professional, Paul has a unique knack for tapping into a brand’s strengths in a way that resonates with stakeholders and external audiences alike. 
                      <br /><br />During the global pandemic, he identified an almost universal desire for simplicity amid uncertainty, spurring him to establish an independent, boutique agency, Spearhead Creativity. Today, Spearhead Creativity works with upcoming, pivoting, and legacy brands alike, guiding them through the ever-changing new normal via robust brand strategies from inception through to implementation.
                    </p>
                  )}
